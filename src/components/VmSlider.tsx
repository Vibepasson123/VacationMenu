...
const VmSlider: React.FC<VmSliderProps> = ({ minValue, maxValue, step, onValueChange, currentValue }) => {
  return (
    <SliderContainer>
      <SliderLabel>Price Range: {currentValue} €</SliderLabel>
      <StyledSlider
